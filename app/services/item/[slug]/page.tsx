...
const baseItem = (
  ...
  category,
  categoryId: 0,
  templateType: type.includes("体验") ? "experience" : type.includes("包车") ? "route" : "transfer",
  displayOrder: 99,
  nameZh,
  nameEn,
  subtitleZh,
  ...
  images: [img],
  tags: ["提前预约", "中文沟通"],
  routeSectionTitleZh: "热门路线方案",
  routeSectionTitleEn: "Popular Route Plans",
  ...
  inquiryRequired: ["日期", "人数"],
  inquiryPromptFields: ["日期", "人数", "出发地点", "特殊需求"],
  maxGuests: 14,
