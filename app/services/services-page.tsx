...
export function ServicesPage({
  ...
  const managedAirport = selectedManagedService?.type === "交通接送"
    ? selectedManagedService
    : selectedOffer
      ? managed.find(
          (item) =>
