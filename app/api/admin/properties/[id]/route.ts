...
export async function PUT(request:Request,{params}:{params:Promise<{id:string}>}){
 ...
 .bind(String(b.nameZh),String(b.nameEn),String(b.city),String(b.areaZh||""),String(b.areaEn||""),json("tags"),json("images"),JSON.stringify(b.imageCategories||{}),JSON.stringify(b.imageOriginals||{}),Number(b.guests),counts.bedrooms,Number(b.beds),counts.bathrooms,String(b.descriptionZh||""),String(b.descriptionEn||""),json("amenities"),json("highlights"),json("nearby"),Number(b.priceFrom),String(b.priceNote||""),String(b.status||"draft"),Number(id)).run();
